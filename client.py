...
pygame.key.set_repeat(500, 50) #Délai de répétition des touches
pygame.display.set_caption("Tic-tac-toe") #Titre de la fenetre
programIcon = pygame.image.load('images/icon_tic_tac_toe.png') #Icone de la fenetre
